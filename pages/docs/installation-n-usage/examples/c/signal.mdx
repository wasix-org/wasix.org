...
- [WASIX](TODO: link to WASIX Installation with C)
- [WASIX SDK](TODO: link to WASIX SDK Installation)
...
<Callout type="error" emoji="🔴">
  TODO: Write about linking the SysRoot
</Callout>
...
We want to a simple C program that demonstrates how to handle signals in a process. It should set up signal handlers for two signals: `SIGHUP` and `SIGINT`.
...
```shell
$ (TODO)/path/to/wasix-sdk/clang signal.c --target="wasm32-wasi" -o signal.wasm
```
