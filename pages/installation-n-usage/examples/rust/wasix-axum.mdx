...
<Callout type="default" emoji="📦">
  As you can see above we are using the `full` feature of `tokio` to enable all
  the features of the library. We used this to show that the whole tokio library
  works with **WASIX**.
</Callout>
...
<Callout type="warning" emoji="🚧">
  TODO: Currently, we need to run it using `wasmer run`
</Callout>
...
- How to **patch** dependencies to make them work with wasix.
