...
12. **Compiler Support**: WASIX provides toolchains for Rust and C / C++.
...
15. **Browser Support**: WASIX supports the browser via the Wasmer runtime. Packages can run on the browser using [`@wasmer/wasi`](https://www.npmjs.com/package/@wasmer/wasi)
